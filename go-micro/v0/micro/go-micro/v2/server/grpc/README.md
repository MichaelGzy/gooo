...
The grpc server is a [micro.Server](https://godoc.org/github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/server#Server) compatible server.
...
import (
        ...
        "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-plugins/server/grpc"
)

...
const defaultRepo = "github.com/MichaelGzy/gooo/go-micro/v0/micro/services"
...
func (s *Source) RuntimeName() string {
	if s.Repo == "github.com/MichaelGzy/gooo/go-micro/v0/micro/services" || s.Repo == "" {
		return s.Folder
	}
...
func ParseSource(source string) (*Source, error) {
	...
	if !strings.Contains(source, "github.com") {
		source = "github.com/MichaelGzy/gooo/go-micro/v0/micro/services/" + source
	}

...
import (
	...
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth/provider"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/broker"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/grpc"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/selector"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/config"
	configSrc "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/config/source"
	configSrv "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/config/source/service"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/profile"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/profile/http"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/profile/pprof"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/trace"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/logger"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry"
	registrySrv "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry/service"
	...
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/store"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/transport"
	authutil "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/util/auth"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/util/wrapper"

	// clients
	cgrpc "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/grpc"
	cmucp "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/mucp"

	// servers
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/cli/v2"

	sgrpc "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/server/grpc"
	smucp "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/server/mucp"

	// brokers
	brokerHttp "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/broker/http"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/broker/memory"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/broker/nats"
	brokerSrv "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/broker/service"

	// registries
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry/etcd"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry/mdns"
	rmem "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry/memory"
	regSrv "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/registry/service"

	// runtimes
	kRuntime "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/runtime/kubernetes"
	lRuntime "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/runtime/local"
	srvRuntime "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/runtime/service"

	// selectors
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/selector/dns"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/selector/router"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/client/selector/static"

	// transports
	thttp "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/transport/http"
	tmem "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/transport/memory"

	// stores
	memStore "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/store/memory"
	svcStore "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/store/service"

	// tracers
	// jTracer "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/trace/jaeger"
	memTracer "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/debug/trace/memory"

	// auth
	jwtAuth "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth/jwt"
	svcAuth "github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth/service"

	// auth providers
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth/provider/basic"
	"github.com/MichaelGzy/gooo/go-micro/v0/micro/go-micro/v2/auth/provider/oauth"
)
...
var (
	...
	DefaultFlags = []cli.Flag{
		...
		&cli.StringFlag{
			Name:    "runtime_source",
			Usage:   "Runtime source for building and running services e.g github.com/MichaelGzy/gooo/go-micro/v0/micro/service",
			EnvVars: []string{"MICRO_RUNTIME_SOURCE"},
			Value:   "github.com/MichaelGzy/gooo/go-micro/v0/micro/services",
		},
		&cli.StringFlag{
			Name:    "selector",
